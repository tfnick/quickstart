...
public class MysqlApplyGroupSink extends RichSinkFunction<Tuple2<String, Integer>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        preparedStatement = connection.prepareStatement(ConfigKeys.APPLY_GROUP_SINK_SQL);//insert sql在配置文件中
        super.open(parameters);
    }
    ...
    public void invoke(Tuple2<String, Integer> value, Context context) throws Exception {
        try {
            String idCard = value.f0;
            Integer count = value.f1;
            preparedStatement.setString(1, idCard);
            preparedStatement.setString(2, "idcard_mobile_count");
            preparedStatement.setString(3, String.valueOf(count));
