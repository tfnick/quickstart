 ...
 */
public class AsyncHbaseRequestFunction extends RichAsyncFunction<String, Tuple3<String,Integer,Integer>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        config.getMap().put("hbase.zookeeper.quorum", "192.168.1.168:2181");
    ...
    public void asyncInvoke(String idCard, ResultFuture<Tuple3<String, Integer, Integer>> resultFuture) throws Exception {
        ...
        GetRequest getRequest = new GetRequest("id_card", idCard, "df");
